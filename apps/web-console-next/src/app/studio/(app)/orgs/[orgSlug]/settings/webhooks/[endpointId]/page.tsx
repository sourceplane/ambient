...
function Inner({
  ...
  if (!endpoint) {
    return (
      <EmptyState
        ...
        primaryAction={{ label: "Back to webhooks", href: `/studio/orgs/${orgSlug}/settings/webhooks` }}
      />
    );
  }
  ...
  return (
    <div className="space-y-5">
      <div>
        <Link
          href={`/studio/orgs/${orgSlug}/settings/webhooks`}
      ...
      <DeleteEndpointDialog
        ...
        onDeleted={() => router.push(`/studio/orgs/${orgSlug}/settings/webhooks`)}
      />
    </div>
  );
}
