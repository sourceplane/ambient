...
orun workflow run github:sourceplane/ambient@<ref>//flows/phases/03-infrastructure/workflow.yaml \
...
(ambient as a Blueprint of itself); regenerate them after editing it:
