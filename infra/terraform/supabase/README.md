...
`ambient` organization and stores generated credentials in AWS Secrets
Manager.
...
|-------------|----------------------------|--------------|
| stage       | ambient-stage    | Provisioned  |
| prod        | ambient-prod     | Provisioned  |
| dev         | —                          | Not provisioned |
...
State is stored at:
```
s3://sourceplane-<env>/env/<env>/ambient/supabase/terraform.tfstate
```
...
```
sourceplane/ambient/supabase/stage
sourceplane/ambient/supabase/prod
```
