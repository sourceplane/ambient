// `ambient webhook verify` — local cryptographic verification of a
// ambient outbound webhook delivery (Task 0106).
//
...
//     command is usable on a fresh install with no `ambient login`.
