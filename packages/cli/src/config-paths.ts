...
//   - `~/.config/ambient/credentials.json` (0600)
//   - `~/.config/ambient/config.json`     (0644)
//
// Override via `AMBIENT_CONFIG_DIR` (used heavily by tests).
...
export function resolveConfigDir(): string {
  ...
  // the dir they expect; fall back to `~/.config/ambient` everywhere
