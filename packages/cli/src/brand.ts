...
// `@saas/sdk` client class name (`ambient`) is intentionally NOT part of
...
export const CLI_BIN = "ambient";

/** Product/brand name used in human-facing CLI copy. */
export const PRODUCT_NAME = "ambient";

/** Default API base URL when `--api-url` is not supplied. */
export const DEFAULT_API_URL = "https://api.ambient.sh";
