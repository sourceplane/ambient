...
//   - ambientError hierarchy propagation with request-id passthrough
...
function client(fetchImpl: typeof fetch): ambient {
  return new ambient({ baseUrl: "https://api.test", fetch: fetchImpl });
}
...
describe("AuthClient", () => {
  ...
  it("client.auth is wired onto the ambient class", () => {
