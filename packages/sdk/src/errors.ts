// Typed error hierarchy for the ambient SDK.
//
...
// codes (forward compatibility) fall back to the generic `ambientError`
...
export interface ambientErrorInit {
 ...
 * `quota_exceeded`) decode to this class — `instanceof ambientError`
 * still matches.
 */
export class ambientError extends Error {
  ...
  constructor(init: ambientErrorInit) {
...
export class BadRequestError extends ambientError {
  constructor(init: ambientErrorInit) {
    super(init);
...
export class UnauthenticatedError extends ambientError {
  constructor(init: ambientErrorInit) {
    super(init);
...
export class ForbiddenError extends ambientError {
  constructor(init: ambientErrorInit) {
    super(init);
...
export class NotFoundError extends ambientError {
  constructor(init: ambientErrorInit) {
    super(init);
...
export class ConflictError extends ambientError {
  constructor(init: ambientErrorInit) {
    super(init);
...
export class ValidationError extends ambientError {
...
export class PreconditionFailedError extends ambientError {
  constructor(init: ambientErrorInit) {
    super(init);
...
export class UnsupportedError extends ambientError {
  constructor(init: ambientErrorInit) {
    super(init);
...
export class InternalError extends ambientError {
  constructor(init: ambientErrorInit) {
    super(init);
...
export interface RateLimitErrorInit extends ambientErrorInit {
...
export class RateLimitError extends ambientError {
...
/**
 * Decode an HTTP `Response` into the appropriate `ambientError` subclass.
 *
 * Forward-compatible: unknown error codes resolve to the base `ambientError`.
...
export async function decodeError(
  ...
  switch (envelope.code as ErrorCode) {
    ...
    default:
      ...
      return new ambientError(init);
  }
}

function decodeRateLimit(
  init: ambientErrorInit,
  response: Response,
): RateLimitError {
