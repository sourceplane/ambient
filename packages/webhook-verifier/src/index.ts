 ...
 * signature verifier for ambient outbound webhook deliveries.
 *
...
/**
 * Compute the canonical ambient webhook signature for a payload.
...
/**
 * Verify the HMAC-SHA256 signature of a ambient webhook delivery.
 *
